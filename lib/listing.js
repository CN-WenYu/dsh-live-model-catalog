 ...
 */
/* No config import: this module stays loadable without node_modules. */
...
export const USER_AGENT = 'dsh-live-model-catalog';
 ...
 * @param options - endpoint, protocol, optional key, timeout, caller signal.
 * @returns the parsed entries.
 * @throws {Error} on transport failure, a non-2xx reply, or an unreadable body.
 */
export async function fetchListing({ baseURL, api, apiKey, timeoutMs, signal }) {
